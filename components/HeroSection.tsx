...
export default function HeroSection() {
  ...
  useGSAP(() => {
    // Normal entrance animation, plays only once
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full px-6 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="flex flex-col items-start text-left mt-8 lg:mt-0">
          ...
          <p className="hero-text text-zinc-400 text-lg md:text-xl max-w-xl leading-relaxed mb-10">
            Ditch the generic quotes. Get a hyper-accurate, AI-driven soft offer for your next commercial, multifamily, or fix-and-flip acquisition in exactly 5 minutes.
          </p>

          <div className="hero-text flex flex-col sm:flex-row gap-5 w-full sm:w-auto mb-16">
            <a href="#soft-offer" className="group relative px-8 py-4 rounded-full bg-white text-zinc-950 font-bold text-lg overflow-hidden transition-transform hover:scale-105 inline-flex items-center justify-center gap-2">
          ...
          {/* Minimalist Stats */}
          <div className="hero-text flex gap-8 md:gap-12 border-t border-white/10 pt-8 w-full">
        ...
        <div ref={rightColumn} className="relative w-full h-[600px] lg:h-[700px] hidden lg:flex items-center justify-center overflow-hidden perspective-midrange">
          ...
          <div className="absolute inset-0 fade-mask flex gap-6 justify-center items-center rotate-6 -rotate-y-35 rotate-x-10 scale-[1.4] origin-right">
            ...
            {/* Column 1 (Slower) */}
            <div className="w-[260px] flex flex-col pt-20 animate-marquee-up">
            ...
            <div className="w-[260px] flex flex-col pt-40 animate-marquee-up-fast">
