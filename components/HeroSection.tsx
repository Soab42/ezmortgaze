...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        zIndex: 1,
        background: 'linear-gradient(135deg, #05152D 0%, #1E3A8A 50%, #05152D 100%)'
      }}
    >
      {/* Dynamic Glow Orbs */}
      <div className="glow-orb opacity-80 w-[600px] h-[600px] bg-blue-900/60 top-0 left-0 -translate-x-1/4 -translate-y-1/4 mix-blend-screen z-0" />
      <div className="glow-orb opacity-80 w-[500px] h-[500px] bg-blue-500/30 bottom-0 right-0 translate-x-1/4 translate-y-1/4 mix-blend-screen z-0" /> 
      ...
      <div className="max-w-7xl mx-auto w-full px-6 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="flex flex-col items-start text-left lg:mt-0">
          <div className="hero-text flex items-center gap-3 px-4 py-2 rounded-full glass-panel mb-6 md:mb-8 border-blue-500/20">
            <Zap className="w-4 h-4 text-blue-400" />
            <span className="text-sm font-medium tracking-wide text-blue-100 uppercase">
          ...
          <h1 className="hero-text font-black leading-[1.05] tracking-tight mb-6"
            ...
            <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#F29A0A] via-[#ffcd7d] to-[#F29A0A]">
              in Just 5 Minutes!
            </span>
          </h1>
          ...
          <div className="hero-text flex flex-col sm:flex-row gap-5 w-full sm:w-auto mb-12 md:mb-16">
            <a href="https://softoffer.commerciallendingusa.com/login" className="group relative px-6 py-3 md:px-8 md:py-4 rounded-full bg-white text-zinc-950 font-bold text-base md:text-lg overflow-hidden transition-transform hover:scale-105 inline-flex items-center justify-center gap-2">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#ffb300] via-[#ffcd7d] to-[#fb8c00] opacity-0 group-hover:opacity-100 transition-opacity" />
            </a>
